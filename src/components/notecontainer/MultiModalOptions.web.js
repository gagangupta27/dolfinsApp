    ...
    <View style={styles.container}>
      ...
      {recording && (
        <TouchableOpacity onPress={onStopRecording} style={styles.optionButton}>
          <Feather name="stop-circle" size={24} color="#b0b0b0" />
        </TouchableOpacity>
      )}
      {!recording && (
        <TouchableOpacity
