...
const UserMentionDropdown = ({ data, onMentionSelect, searchText, setSearchText, setIsMentionFocused }) => {
          ...
          <View style={styles.addmentiondbox}>
            <View style={styles.searchicon}>
              <Svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <Path d="M13 13L17 17" stroke="#858585" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <Path d="M1 7.85714C1 11.6442 4.07005 14.7143 7.85714 14.7143C9.75394 14.7143 11.471 13.9441 12.7123 12.6994C13.9495 11.4591 14.7143 9.74743 14.7143 7.85714C14.7143 4.07005 11.6442 1 7.85714 1C4.07005 1 1 4.07005 1 7.85714Z" stroke="#858585" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              </Svg>
            </View>
