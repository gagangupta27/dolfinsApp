...
const ContactItem = ({
    ...
    return (
        <TouchableOpacity style={styles.container} onPress={onPress} onLongPress={() => onLongPress(item)}>
            <View style={styles.contactbase}>
                <View style={styles.contactdetails}>
                    <Text style={styles.contactname}>{item.name}</Text>
                    {item.contactposition && <Text style={styles.contactposition}>{item.contactposition}</Text>}
                </View>
                {item.notedetails && (
